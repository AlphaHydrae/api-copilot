...
// * `parameterExtensions` - functionality related to runtime parameters (see [scenario.params.js](scenario.params.js.html));
...
module.exports = function(Client, parameterExtensions, log4js, print) {
  ...
  _.extend(Scenario.prototype, {
    ...
    run: function(options) {
      ...
      // This is handled in [scenario.params.js](scenario.params.js.html).
      return q.fcall(_.bind(this.processParameters, this), runOptions).then(_.bind(this.runScenario, this, runOptions));
    },
  ...
  }, ScenarioClientExtensions, parameterExtensions);
...
module.exports['@require'] = [ 'client', 'scenario.params', 'log4js', 'cli.print' ];
