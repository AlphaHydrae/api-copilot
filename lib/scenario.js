  ...
  _.extend(Scenario.prototype, {
    ...
    getNextStep: function() {
      ...
      if (!nextStep) {
        ...
        step = this.steps[_.indexOf(this.steps, this.currentStep) + 1];
        if (!step) {
          return;
        }
      }
    ...
    success: function() {
      return fulfill(new StepArgs(slice.call(arguments)));
    },
    ...
    skip: function(message) {
      ...
      return fulfill(new StepArgs(slice.call(arguments, 1)));
    },
    ...
    runStep: function(step, deferred) {
      ...
      q.when(step.definition.apply(this, stepArgs), _.bind(this.handleStepResult, this, deferred, description), _.bind(this.handleStepError, this, deferred, description));
    },
