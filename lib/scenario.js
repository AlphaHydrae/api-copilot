...
module.exports = function(extensions, log4js, print) {
  ...
  _.extend(Scenario.prototype, {
    ...
    onConfigure: function(options) {
      ...
      // TODO: move this to client extensions
      ...
      if (options.log && this.logger.level && this.logger.level.toString() != options.log.toUpperCase()) {
    ...
    run: function(options) {
      ...
      runOptions.log = runOptions.log || 'info';
