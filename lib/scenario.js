...
module.exports = function(deps) {
  ...
  _.extend(Scenario.prototype, {
    ...
    param: function(name, options) {
      options = _.extend({
        required: true,
        message: 'Unknown parameter "' + name + '"; give it to the Scenario object at construction or from the command line with the -p, --params option'
      }, options);
    ...
    handleStepResult: function(deferred, description) {
      ...
      // The scenario is stopped if there are no more steps to run.
      if (!nextStep) {
