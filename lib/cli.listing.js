...
module.exports = function(deps) {
  ...
  _.extend(Listing.prototype, {
    ...
    display: function(scenarios) {
      ...
      print('Available API scenarios (' + scenarios.length + '):');
    ...
    displayInfoNotice: function(scenarios) {
      if (scenarios.length) {
        print();
        print('Use `api-copilot info [scenario]` for more information about a scenario.');
        print('Use `api-copilot run [scenario]` to run a scenario.');
