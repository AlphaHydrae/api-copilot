...
module.exports = function(deps) {
  ...
  _.extend(Program.prototype, {
    ...
    executeAction: function(name, command) {
      ...
      var args = _.compact(slice.call(arguments, 2, -1));
    ...
    buildCommand: function() {
      ...
      program
        ...
        .action(_.bind(this.executeAction, this, 'list', program));

      program
        .command('info [scenario]')
        .description('describe an API scenario')
        .action(_.bind(this.executeAction, this, 'info', program));

      program
        .command('run [scenario]')
        .description('run an API scenario')
        .action(_.bind(this.executeAction, this, 'run', program));
