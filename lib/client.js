...
exports.inject = function(deps) {
  ...
  _.extend(Client.prototype, {
    ...
    request: function(options) {
      ...
      return this.buildRequestOptions(options).then(_.bind(this.sendRequest, this, requestNumber, startTime))
        .spread(_.bind(this.handleResponse, this, requestNumber, startTime), _.bind(this.handleError, this, requestNumber));
    },

    sendRequest: function(requestNumber, startTime, requestOptions) {
